        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card  className="bg-neutral-900/50 border-2 relative scale-105 border-green-500 shadow-2xl shadow-green-800/40  rounded-3xl   bg-gradient-to-b from-green-700/30 to-90% to-transparent b  ">
            ...
            <CardContent className="space-y-4 z-20">
              <div>
              <span className="text-5xl font-bold font-serif">₹</span>

                <span className="text-5xl text-white z-20 font-bold">2.99</span>
              ...
              <div className="space-y-2">
                ...
                <div className="text-green-500">+3 EXTRA months</div>
              </div>
            </CardContent>
          ...
          <Card className="bg-neutral-900/50 border-neutral-800">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-green-600">+3 EXTRA months</div>
              </div>
            </CardContent>
            <CardFooter className="flex flex-col gap-4">
              <Button className="w-full ">
