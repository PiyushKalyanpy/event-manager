...
const EventCard = (event: any) => {
    ...
    return (
        <Card className=" hover:scale-105  p-4 h-fit w-full bg-neutral-900 border-0 group/item">
            ...
            <CardBody className=" flex gap-4 ">
                ...
                {!isEventPage && (
                    <div className="flex  items-center gap-4  ">
                        ...
                        <IconWithValue icon={Ticket} label="30 tickets left" />
                    </div>
                )}
            </CardBody>
            ...
            <CardFooter className=" border-t  ">
                <div className="flex justify-between w-full">
                    <div>
                        ...
                        <p className="text-sm py-1 text-neutral-400 ">vip</p>
                    </div>
